...
%(c)\includegraphics[width=5in]{fig/spotviz_RGtable.png}
  (a)\includegraphics[width=5in]{fig/Fig4a_top_blankstruc.png}\\
  \includegraphics[width=5in]{fig/Fig4a_middle_blankstruc.png}\\
(b)\includegraphics[width=5in]{fig/Fig4b_blankstruc.png}\\
(c)\includegraphics[width=5in]{fig/Fig4c_RGtable_blankstruc.png}
...
\begin{figure}
\includegraphics[width=6in]{fig/mol1_RGtool_scafpie_v2.png}
