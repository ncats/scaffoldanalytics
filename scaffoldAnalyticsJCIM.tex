...
Comparing the Data-Driven Frameworks and NCATS R-Group decomposition for the TCAMS dataset using the above mentioned statistical metrics, we show the aggregate statistics over the entire dataset in \fref{statcompare}(a) and the PIU (proportion of information unique to each method) and ratio of Fragment Efficiencies for all 13.5k molecules in \fref{statcompare}(b). We can make a few observations from this data and plot:
\begin{enumerate} 
