...
are described in the Supporting Information in section S3.
...
has been superseded by the ScaffoldHopper tool, available from \url{https://spotlite.nih.gov/ncats/scaffold-hopper}.
...
in Supporting Information Tables S1 \& S2.
...
the frameworks code are provided in the Supporting Information Section S4. 
...
%Supporting Information in Section S5.
%
...
method are detailed in the Supporting Information, Section S5.
...
\item {\bf Related Molecules Tab}: The purpose of this tab is to explore the
  ...
  Related Molecules.
  \subitem {\bf Scaffold Trellis}: This scatter
  ...
  capabilities.
  \subitem {\bf Scaffold Pies}: Instead of using a
...
in the Supporting Information, Section S6. In addition, we discuss several
...
as part of the Supporting Information in Section S10.
...
%complete-
%can be averaged over all compounds in a dataset to
...
%characterize the dataset and partitioning or overlapping scaffolds used to
%characterize it.
...
Further examples of the value of Scaffold Walking are in the Supporting Information, Section S7.
...
previously, and illustrated with an example in Supporting Information,
...
\begin{figure}
  ...
  \end{tabular}
    ...
    \scalebox{0.7}{
      (b)\begin{tabular}{|c|ccc|c|}
    \hline
    {\bf Column} & {\bf P10} & {\bf Median} & {\bf P90} & {\bf Avg} \\
    \hline    
    {\bf $C_D$} & 3.00 & 17.00 & 88.00 & 33.11 \\
    {\bf $C_B$} & 83.50 & 888.00 & 2151.00 & 1047.93 \\
    {\bf $CP$} & 0.00 & 0.02 & 0.17 & 0.07 \\
    {\bf $PI_D$} & 0.00 & 0.02 & 0.2 & 0.09 \\
    {\bf $PI_B$} & 0.98 & 1.00 & 1.00 & 0.98 \\
    {\bf $PIU_D$} & 0.00 & 0.00 & 0.02 & 0.02 \\
    {\bf $PIU_B$} & 0.79 & 0.98 & 1.00 & 0.91 \\
    {\bf $Frag_D$} & 1.00 & 1.00 & 1.00 & 1.00 \\
    {\bf $Frag_B$} & 2.00 & 5.00 & 11.00 & 5.93 \\
    {\bf $FragEff_D$} & 3.00 & 17.00 & 88.00 & 33.11 \\
    {\bf $FragEff_B$} & 21.25 & 150.80 & 454.00 & 211.80 \\
    \hline
  \end{tabular}
 }\\
...
\begin{acknowledgement}
  ...
  The authors declare the following sources of funding: authors DB, CK,
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{suppinfo}
  Supporting information is available online for this article.\\
  The public datasets used in this tool, intermediate files derived using the various methods, final Spotfire files and prior presentations on this work are posted within the Git repo used to compile the paper, now made public: \url{https://spotlite.nih.gov/ncats/scaffoldanalytics}.\\
The code for the NCATS R-Group Tool, now known as Scaffold Hopper is also available: \url{https://spotlite.nih.gov/ncats/scaffold-hopper}
...
\newpage
%% w=3.25in, h=1.75in, scaled 1.5x: 3.25+1.625, 1.75+0.875: w=4.875, h=2.625 
\begin{figure*}
%    \includegraphics[width=4.875in,height=2.625in]{fig/TOC_image_v2.png}
