...
{\bf Conclusion:}\\
In summary, by combining anecdotal and statistical methods to
compare partitioning and fuzzy clustering methods and their application to analysis of HTS datasets, we found that fuzzy clustering provides much better coverage of these datasets, and that different fuzzy clustering methods are comparable. Screening scientists have traditionally used ``chemical intuition'' 
to select and examine scaffolds, which can lead to biased scaffold selection and
subsequently biased lead optimization. Our Scaffold-Based Analytics approach described in this study
