...
scaffolds for diverse datasets.  This approach still assigns only one scaffold for each molecule, in the order selected by the user from a prioritized list.   

Next, we describe several methods we have assembled as part of our workflow that enables multiple scaffolds to be assigned to each molecule and easy navigation between molecules related by these scaffolds. 
