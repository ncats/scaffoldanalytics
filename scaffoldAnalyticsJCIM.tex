...
\caption{Scaffold Decompositions for a molecule (a) from the TCAMS dataset with Compound ID 536182. (b) 5 scaffolds from NCATS R-Group Tool; (c) 24 GSK frameworks -- first 21 Bemis-Murcko Like and last 3 in the bottom row RECAP.}
...
2, Compound ID: 533945, ) ranked by average activity and IFI. This ordering may
...
\begin{figure}
  ...
  \caption{All \~5000 scaffolds from the TCAMS dataset ranked by average pIC50 in the P.~falciparum 3D7 strain and Inhibition Frequency Index. The six scaffolds contained in Compound C (Compound ID: 541564) are shown in increasing order of average pIC50.}
\label{fig:RGTaggr}   
\end{figure}
...
\caption{Iterative Related Molecules scaffold pies visualization for Molecule 3 (Compound ID: 541531), a scaffold hop from Molecule 2 shown in \fref{scafwalk2}. Each pie here is one related molecule, and each pie sector and color is a scaffold that it shares with the parent molecule. The star symbol is added to show the location of the parent molecule in this plot, and the compass device at the origin shows the direction of favorable properties (in this case towards the +X and -Y axes). Insights derived from the plot are highlighted in the figure and also discussed in the text.}
\label{fig:scafwalk3}
\end{figure}
