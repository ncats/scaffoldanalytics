...
using the aggregated data as a filter. Another advantage is the inclusion of ``virtual
...
compare partitioning and fuzzy clustering methods and their application to analysis of HTS datasets, we found that fuzzy clustering provides much better coverage of these datasets, and that different fuzzy clustering methods are comparable.
Screening scientists have traditionally
used ``chemical intuition'' to select and examine scaffolds,
which can lead to biased scaffold selection and
