...
Our method for quantifying structure-activity overlap via NormCP is novel, though similar in spirit and purpose to local hit rate calculations that have been proposed for HTS triage\cite{Posner2009}, with a comprehensive structural neighbor metric based on overlapping scaffolds. It will be interesting to see this metric being used and compared with existing methods more widely, which we hope future authors will take on.      
