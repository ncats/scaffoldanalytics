...
assays: 
\begin{itemize}
\item An {\it FBDD} (fragment-based drug design) screen run in 2011 with {\bf 288} hits.
\item A {\it full HTS} run in 2012 with {\bf 4564} {pIC50s} measured after screening 2 million compounds.
\item A {\it top-up HTS} run in 2014 with {\bf 3613} {pIC50s} measured after screening 350,000 compounds.
\end{itemize}
A fourth dataset comprises {\bf 824} virtual compounds selected from {\it ELT}, a DNA Encoded Library Technology screen\cite{ELT} of 130 combinatorial libraries with billions of potential molecules.
